...
export interface TokenAbiInterface extends utils.Interface {
  contractName: "TokenAbi";
  functions: {
    ...
    "passMinterRole(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "passMinterRole",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface TokenAbi extends BaseContract {
  ...
  callStatic: {
    ...
    passMinterRole(dBank: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    ...
    MinterChanged(from?: string | null, to?: null): MinterChangedEventFilter;
